...
import { testConnection, startAnonymously, getCurrentUser, signOut } from './lib/supabase.js'

function App() {
  const [user, setUser] = useState(null)
  const [loading, setLoading] = useState(true)
  const [connectionStatus, setConnectionStatus] = useState('testing')
  const [currentPhase, setCurrentPhase] = useState('welcome') // welcome, onboarding, main
...
// 🎨 Styles (Inline for simplicity - can be moved to CSS file later)
const styles = {
  appContainer: {
